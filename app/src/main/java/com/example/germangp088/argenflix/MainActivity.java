...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        peliculaList.add(new Pelicula(getBaseContext(), "Muzzarela", R.drawable.muzzarella, 10));
        peliculaList.add(new Pelicula(getBaseContext(), "Napolitana", R.drawable.napolitana, 15));
        peliculaList.add(new Pelicula(getBaseContext(), "Jamon y queso", R.drawable.jamon, 20));

        ListView lv = findViewById(R.id.pelicula_lv);
        lv.setAdapter(new PeliculaAdapter(getBaseContext(), peliculaList));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getBaseContext(), "Ir hacia AddPeliculaActivity", Toast.LENGTH_SHORT).show();
            }
        });
    }
